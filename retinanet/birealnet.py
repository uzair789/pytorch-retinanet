...
class PyramidFeatures(nn.Module):
    def __init__(self, C3_size, C4_size, C5_size, feature_size=256, is_bin=False):
        ...
        self.avgPool6 = nn.AvgPool2d(kernel_size=2, ceil_mode=True )
        #self.P6_down = conv2d(C5_size, feature_size, kernel_size=1, stride=2, padding=0)
        self.P6_down = conv2d(C5_size, feature_size, kernel_size=1, stride=1, padding=0)
        ...
        self.avgPool7 = nn.AvgPool2d(kernel_size=2, ceil_mode=True)
        self.P7_down = conv2d(feature_size, feature_size, kernel_size=1, stride=1, padding=0)
