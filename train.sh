...
EXP_NAME="BiRealNet10_FFF_teacher_Dis-729_student_Dis-726_batchnorm_freeze_False_manual_diff_forward_distillation_head_LambdaLR_lr${LR}_CDC{$CDC}_RDC{$RDC}_CLC{$CLC}_RLC{$RLC}"
