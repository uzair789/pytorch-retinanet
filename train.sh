...
EXP_NAME="new_teacher-Dis-644_teacher.evaltest_student-Dis-683_batchnorm_freeze_False_manual_same_forward_distillation_head_LambdaLR_lr${LR}_CDC{$CDC}_RDC{$RDC}_CLC{$CLC}_RLC{$RLC}"
#EXP_NAME='dummy'
