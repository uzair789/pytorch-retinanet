...
EXP_NAME="bn_unfreeze_normalizedLogitMapEpoch4nitialization_LambdaLRModel_teacher_changed_every_epoch_consistent_rerun_BiRealNet18_backbone_plus_heads_shortcuts_binary_from_scratch_LambdaLR_binary_FPN_distillation_head_LambdaLR_lr${LR}_CDC{$CDC}_RDC{$RDC}_CLC{$CLC}_RLC{$RLC}"
