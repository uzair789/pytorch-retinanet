...
EXP_NAME="resnet18_binary_backbone_distillation_head_teacher_layer12_cdc${CDC}_rdc${RDC}_fdc${FDC}"
#EXP_NAME="resnet18_layer123_binary_backbone_distillation_head_teacher_layer12_cdc${CDC}_rdc${RDC}_fdc${FDC}"
