...
EXP_NAME="normalized_logit_map_BiRealNet18_backbone_plus_heads_shortcuts_binary_from_scratch_binary_FPN_distillation_head_LambdaLR_lr${LR}_CDC{$CDC}_RDC{$RDC}_CLC{$CLC}_RLC{$RLC}"
