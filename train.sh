...
EXP_NAME="seprate_CLassRegressPyramid_for_Bireal_reproduce_rerun_commit_BiRealNet18_backbone_plus_heads_shortcuts_binary_from_scratch_distillation_head"
