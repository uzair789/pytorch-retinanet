...
EXP_NAME="normalizedLogitMapEpoch4InitializationLambdaLRModelTeacherChangedEveryEpochConsistent_updated_birealnet.py_Dis-653_batchnorm_freeze_False_distillation_head_LambdaLR_lr${LR}_CDC{$CDC}_RDC{$RDC}_CLC{$CLC}_RLC{$RLC}"
#EXP_NAME='dummy'
