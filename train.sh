...
EXP_NAME="normalizedLogitMapEpoch4InitializationLambdaLRModelTeacherChangedEveryEpochConsistenty_Dis-650_batchnorm_freeze_True_distillation_head_LambdaLR_lr${LR}_CDC{$CDC}_RDC{$RDC}_CLC{$CLC}_RLC{$RLC}"
#EXP_NAME='dummy'
